<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Welcome to your manTcic Life application!
    </div>

    <div class="mt-6 text-gray-500">
        manTis Life provides a beautiful and robust starting point for your next maintenance project for the life cycle of any physical asset.. manTcic Life is designed
        to help you build your project using a development environment that is simple, powerful, and enjoyable. We believe
